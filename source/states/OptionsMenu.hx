...
class OptionsMenu extends MusicBeatState
{
	...
	public var pages:Array<Dynamic> = [
		...
		[
			...
			new StringSaveOption("Time Bar Style", ["leather engine", "psych engine", "jpsych engine", "new kade engine", "old kade engine"], 7, "timeBarStyle"),
			new StringSaveOption("Gengo", ["eng", "jp"], 8, "kotoba"),
		...
		[
			...
			new StringSaveOption("Rating Mode", ["psych", "jpsych", "simple", "complex"], 2, "ratingType"),
