...
class TitleState extends MusicBeatState
{
	...
	public static var version:String = "v0.1.0";

	public static var version_New:String = "v0.1.0";
	...
	function startIntro()
	{
		...
		version = '${MusicBeatState.windowNamePrefix} (v${Assets.getText("version.txt")}) (LE 0.4.2)';
